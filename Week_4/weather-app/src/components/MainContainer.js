...
function MainContainer(props) {
    ...
    const apiKey = "8e7265170a89aebc23b02e1c63a84f6a"; // Replace with your own API key
        ...
        */}
                ...
                {weather && (
                    <>
                        ...
                        <img src={require(`../icons/${weather.weather[0].icon}.svg`)}
                            ...
                            if (index % 8 === 0) {
                                return (
                                    <div key={index}>
                                        ...
                                        <img src={require(`../icons/${dayData.weather[0].icon}.svg`)}
